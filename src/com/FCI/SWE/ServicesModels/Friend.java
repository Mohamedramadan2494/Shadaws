...
public static boolean checkFriend(String name,String name2) {
	DatastoreService datastore = DatastoreServiceFactory
			.getDatastoreService();
	...
	for (Entity entity : pq.asIterable()) {
		if (  ((entity.getProperty("RequestTo").toString().equals(name)&&
		   entity.getProperty("RequestFrom").toString().equals(name2))||
		   ((entity.getProperty("RequestFrom").toString().equals(name)&&
				   entity.getProperty("RequestTo").toString().equals(name2))) )&&
